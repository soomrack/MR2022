...
int main()
{
  ...
  double deposit = 0.00125, resultA = 1000000, contributionA = 0.0, moneyA = 1000000, resultB =
    1000000 - downpayment, moneyB = 1000000, contributionB = 0.0;
