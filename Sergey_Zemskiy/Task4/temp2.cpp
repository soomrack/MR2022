...
int main() {
    ...
    Matrix_Mem<double> C = A + B;
    C.print();
    std::cout << "A - B" <<std::endl;
    Matrix_Mem<double> D = A - B;
    D.print();
    std::cout << "A * 1.1" <<std::endl;
    Matrix_Mem<double> E = A * 1.1;
    E.print();
    std::cout << "A * B" << std::endl;
    Matrix_Mem<double> F = A * B;
    F.print();
    std::cout << "A ^ 3" << std::endl;
    Matrix_Mem<double> G = A ^ 3;
    G.print();
    std::cout << "Single(3)" << std::endl;
    Matrix_Mem<double> H (A.get_columns());
    H.Single();
    H.print();
    std::cout << "exp(A)" << std::endl;
    A.report();
    Matrix_Mem<double> K = A.exp(3);
    K.print();
    return 0;
}
