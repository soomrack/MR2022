...
struct Rectangle{
    Rectangle (double x1_temp, double x2_temp, double y1_temp, double y2_temp) :
    x1(x1_temp), x2(x2_temp), y1(y1_temp), y2(y2_temp) {}
    double x1;
    double x2;
    double y1;
    double y2;
...
public:
    ...
    Node(Rectangle x_temp) : x(x_temp), left_child(nullptr), right_sibling(nullptr) {}
};
