...
VPInt hungarian(const VVInt& matrix) {
    ...
    //Массив флагов visited[] из width элементов. Единичками в этом массиве отмечены посещенные столбцы
    //Массив ссылок links[] из width элементов. По этому массиву можно построить все цепочки, начинающиеся в посещенных отмеченных элементах
    //Массив значений mins[] из width элементов
