...
int main(int argc, char const *argv[])
{
  ...
  std::cout << "Divide by a scalar test: " << (test_divide_by_scalar() ? "Success\n" : "Fault\n");
  std::cout << "Triangle matrix test: " << (test_triangle_matrix() ? "Success\n" : "Fault\n");
  std::cout << "Transposed matrix test: " << (test_transposed() ? "Success\n" : "Fault\n");
  std::cout << "Determinant of matrix test: " << (test_determinant() ? "Success\n" : "Fault\n");
  ...
  std::cout << "Exception division by zero test: " << (test_exception_division_by_zero() ? "Success\n" : "Fault\n");
  std::cout << "Exception not square test: " << (test_exception_not_square() ? "Success\n" : "Fault\n");
  std::cout << "Exception matrix boundary test: " << (test_exception_matrix_boundary() ? "Success\n" : "Fault\n");
