...
Matrix create_zero_matrix(const unsigned int rows, const unsigned int cols) { //Создание матрицы из нолей
...
Matrix create_unit_matrix(const unsigned int size) { // Создание единичной матрицы
